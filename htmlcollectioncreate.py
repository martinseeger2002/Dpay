...
"""
    encoded_message = base64.b64encode('Hello World! MUCH WOW FROM @DOGEPAY_DRC20, @GREATAPE42069E, @MartinSeeger2 MUCH ENJOY! SUCH FREE AIRDROP!'.encode()).decode()
